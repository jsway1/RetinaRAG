...
The performance of the Mistral 7B Instruct model was evaluated both with and without RAG augmentation. Responses were compared to an ideal response sourced from the RAG library via cosine similarity. Results are provided in the plot below. The RAG system outperformed the LLM only approach for all questions, but to varying degrees. The LLM struggled to provide concise answers for complex questions without RAG augmentation. The code for this comparison is provided in the "notebooks" folder. The questions used are provided in the "model_eval_questions.txt" text file. 


<img width="947" alt="Screenshot 2024-07-10 at 3 50 45 PM" src="https://github.com/jsway1/RetinaRAG/assets/45215554/4e3d79f4-1b45-4af2-93e9-2d77205a5a6d">
