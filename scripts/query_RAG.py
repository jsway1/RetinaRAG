...
def main():
    parser = argparse.ArgumentParser(description='Test script for RAG application')
    parser.add_argument('query', type=str, help='Query text to be processed by the RAG system')
